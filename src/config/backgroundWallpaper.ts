...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		// 桌面背景图片（支持单张或多张随机）
		desktop: "assets/images/home-background/home-cyber-anime.webp",
		// 移动背景图片（支持单张或多张随机）
		mobile: "assets/images/home-background/home-cyber-anime-mobile.webp",
	},
	// 横幅壁纸和全屏壁纸共享配置
	common: {
		...
		homeText: {
			...
			subtitle: [
				...
				"把零散笔记变成可复用的知识系统",
				"Code notes, system thinking, field practice",
				"在技术、认知和行动之间建立连接",
			],
			// 主页横幅副标题字体大小
